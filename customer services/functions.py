...
# Calculates the percebtage of the message that should the chat bot respond to
...
# Simplifies response creation and adds it to the dictionary
...
# Returns that the chat bot cannot understand the user's input    
    return long.unknown() if highest_prob_list[best_match] < 1 else best_match

# Gets the user's input, slipts the sentance to individual words and makes them lower case
